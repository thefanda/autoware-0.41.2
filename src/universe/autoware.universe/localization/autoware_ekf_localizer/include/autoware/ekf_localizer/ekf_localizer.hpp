...
private:
  ...
  rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr gnss_sub_initialpose_;
  rclcpp::Subscription<dfcv_mining_msgs::msg::LocationIMU>::SharedPtr sub_location_imu;
  ...
  geometry_msgs::msg::TwistWithCovarianceStamped twist_cov_; 
   ...
   */
  void timer_callback();
  void imucallback(const dfcv_mining_msgs::msg::LocationIMU::SharedPtr msg);

  
 void callback_gnss(const geometry_msgs::msg::PoseStamped::SharedPtr gnss_msg);
  /**
