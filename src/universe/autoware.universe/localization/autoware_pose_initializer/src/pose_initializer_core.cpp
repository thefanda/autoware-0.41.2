...
{
  RCLCPP_INFO(this->get_logger(), "PoseInitializer node constructed11111111111111111111111111111111111111111111111111111");
...
{
  if (gnss_) {
    std::cout << "Pose received: 1111111111111111111111111111111111111111111111111111111111111111111111111111" << std::endl;
