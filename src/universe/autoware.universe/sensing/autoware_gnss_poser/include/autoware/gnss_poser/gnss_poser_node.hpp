...
private:
  ...
  void callback_nav_sat_fix(const dfcv_mining_msgs::msg::LocationIMU::ConstSharedPtr nav_sat_fix_msg_ptr);
  ...
  autoware::component_interface_utils::Subscription<MapProjectorInfo>::SharedPtr
   ...
   rclcpp::Subscription<dfcv_mining_msgs::msg::LocationIMU>::SharedPtr nav_sat_fix_sub_;
