...
This node is a CUDA accelerated version of the `FasterVoxelGridDownsampleFilter` available in [autoware_pointcloud_preprocessor](../../autoware_pointcloud_preprocessor).

## Inner-workings / Algorithms

This node reimplements of the function of `autoware::pointcloud_preprocessor_v49::FasterVoxelGridDownsampleFilter`, which calculates centroids as representative points in each voxels.
...
{{ json_to_markdown("sensing/autoware_cuda_pointcloud_preprocessor_v49/schema/cuda_voxel_grid_downsample_filter.schema.json") }}
