...
#include "autoware/cuda_pointcloud_preprocessor_v49/cuda_concatenate_data/cuda_combine_cloud_handler.hpp"

#include "autoware/cuda_pointcloud_preprocessor_v49/cuda_concatenate_data/cuda_combine_cloud_handler_kernel.hpp"
#include "autoware/cuda_pointcloud_preprocessor_v49/cuda_concatenate_data/cuda_traits.hpp"
...
static_assert(
  sizeof(autoware::pointcloud_preprocessor_v49::PointTypeStruct) ==
  sizeof(autoware::point_types::PointXYZIRC));

CHECK_OFFSET(
  autoware::pointcloud_preprocessor_v49::PointTypeStruct, autoware::point_types::PointXYZIRC, x);
CHECK_OFFSET(
  autoware::pointcloud_preprocessor_v49::PointTypeStruct, autoware::point_types::PointXYZIRC, y);
CHECK_OFFSET(
  autoware::pointcloud_preprocessor_v49::PointTypeStruct, autoware::point_types::PointXYZIRC, z);
CHECK_OFFSET(
  autoware::pointcloud_preprocessor_v49::PointTypeStruct, autoware::point_types::PointXYZIRC,
  intensity);
CHECK_OFFSET(
  autoware::pointcloud_preprocessor_v49::PointTypeStruct, autoware::point_types::PointXYZIRC,
  return_type);
CHECK_OFFSET(
  autoware::pointcloud_preprocessor_v49::PointTypeStruct, autoware::point_types::PointXYZIRC, channel);

namespace autoware::pointcloud_preprocessor_v49
{
  ...
  const std::shared_ptr<CollectorInfoBase> & collector_info)
{
  ...
  concatenate_cloud_result.concatenation_info_ptr =
    std::make_unique<autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo>(
  ...
  for (const auto & [topic, cloud] : topic_to_cloud_map) {
    ...
    concatenation_info_manager_.update_source_from_point_cloud(
      *cloud, topic, autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_OK,
      *concatenate_cloud_result.concatenation_info_ptr);
  }
...
template class autoware::pointcloud_preprocessor_v49::CombineCloudHandler<
  autoware::pointcloud_preprocessor_v49::CudaPointCloud2Traits>;
