...
#include "autoware/cuda_pointcloud_preprocessor_v49/cuda_outlier_filter/cuda_polar_voxel_outlier_filter_node.hpp"

#include "autoware/pointcloud_preprocessor_v49/filter.hpp"  // for get_param
#include "autoware/pointcloud_preprocessor_v49/utility/memory.hpp"  // for autoware::pointcloud_preprocessor_v49::utils
...
: Node("cuda_polar_voxel_outlier_filter_v49", node_options), updater_(this)
{
  ...
  std::string diagnostics_hardware_id =
    declare_parameter<std::string>("hardware_id", "cuda_polar_voxel_outlier_filter_v49");
  ...
  visibility_pub_ = create_publisher<autoware_internal_debug_msgs_v49::msg::Float32Stamped>(
    "~/debug/visibility", rclcpp::SensorDataQoS());

  // Create ratio publisher
  ratio_pub_ = create_publisher<autoware_internal_debug_msgs_v49::msg::Float32Stamped>(
  ...
  const cuda_blackboard::CudaPointCloud2::ConstSharedPtr msg)
{
  ...
  bool has_polar_coords =
    autoware::pointcloud_preprocessor_v49::utils::is_data_layout_compatible_with_point_xyzircaedt(*msg);
  bool has_return_type =
    autoware::pointcloud_preprocessor_v49::utils::is_data_layout_compatible_with_point_xyzirc(*msg);
  ...
  if (has_polar_coords) {
    ...
    RCLCPP_ERROR(
      ...
      "autoware_cuda_pointcloud_preprocessor_v49::cuda_polar_voxel_outlier_filter yet.");
  }
  ...
  if (ratio_pub_) {
    autoware_internal_debug_msgs_v49::msg::Float32Stamped ratio_msg;
  ...
  if (visibility_pub_ && visibility_.has_value()) {
    autoware_internal_debug_msgs_v49::msg::Float32Stamped visibility_msg;
...
RCLCPP_COMPONENTS_REGISTER_NODE(
  autoware::cuda_pointcloud_preprocessor_v49::CudaPolarVoxelOutlierFilterNode)
