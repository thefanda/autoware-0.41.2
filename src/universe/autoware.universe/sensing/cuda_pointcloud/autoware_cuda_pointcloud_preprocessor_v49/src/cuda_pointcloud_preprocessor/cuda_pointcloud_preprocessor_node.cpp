...
#include "autoware/cuda_pointcloud_preprocessor_v49/cuda_pointcloud_preprocessor_node.hpp"
...
#include "autoware/pointcloud_preprocessor_v49/diagnostics/distortion_corrector_diagnostics.hpp"
...
: Node("cuda_pointcloud_preprocessor_v49", node_options),
...
// Subscriber
  ...
  // initialize debug tool
  {
    ...
    debug_publisher_ = std::make_unique<DebugPublisher>(this, "cuda_pointcloud_preprocessor_v49");
  ...
  const std::unique_ptr<cuda_blackboard::CudaPointCloud2> & output_pointcloud_ptr)
{
  ...
  auto distortion_corrector_diag =
    std::make_shared<autoware::pointcloud_preprocessor_v49::DistortionCorrectorDiagnostics>(
...
RCLCPP_COMPONENTS_REGISTER_NODE(
  autoware::cuda_pointcloud_preprocessor_v49::CudaPointcloudPreprocessorNode)
