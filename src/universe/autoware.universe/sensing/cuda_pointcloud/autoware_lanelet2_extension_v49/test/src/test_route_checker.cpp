...
#include <autoware_map_msgs_v49/msg/lanelet_map_bin.hpp>
#include <autoware_planning_msgs_v49/msg/lanelet_route.hpp>
...
public:
  TestSuite() : sample_map_ptr(new lanelet::LaneletMap())
  {
    ...
    autoware_planning_msgs_v49::msg::LaneletPrimitive map_primitive;
    autoware_planning_msgs_v49::msg::LaneletSegment map_segment1;
    autoware_planning_msgs_v49::msg::LaneletSegment map_segment2;
  ...
  autoware_planning_msgs_v49::msg::LaneletRoute sample_route1;  // valid route
  autoware_planning_msgs_v49::msg::LaneletRoute sample_route2;  // invalid route
...
{
  autoware_map_msgs_v49::msg::LaneletMapBin bin_msg;

  const auto route_ptr1 =
    std::make_shared<autoware_planning_msgs_v49::msg::LaneletRoute>(sample_route1);
  const auto route_ptr2 =
    std::make_shared<autoware_planning_msgs_v49::msg::LaneletRoute>(sample_route2);
