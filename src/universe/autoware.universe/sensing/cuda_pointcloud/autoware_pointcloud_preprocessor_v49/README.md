...
| ----------------------------- | ---------------------------------------------------------------------------------- | --------------------------------------------- |
| concatenate_data_v49              | subscribe multiple pointclouds and concatenate them into a pointcloud              | [link](docs/concatenate-data.md)              |
...
`autoware::pointcloud_preprocessor_v49::Filter` is implemented based on pcl_perception [1] because
...
- `/sensing/lidar/concatenate_data_v49_synchronizer/debug/sensing/lidar/LidarX/pointcloud/pipeline_latency_ms`
