...
This implementation inherits `autoware::pointcloud_preprocessor_v49::Filter` class, please refer [README](../README.md).
...
# <node pkg="autoware_pointcloud_preprocessor" exec="polar_voxel_outlier_filter_node_v49" name="polar_voxel_filter">
...
// Create node
auto node = std::make_shared<autoware::pointcloud_preprocessor_v49::PolarVoxelOutlierFilterComponent>(options);
