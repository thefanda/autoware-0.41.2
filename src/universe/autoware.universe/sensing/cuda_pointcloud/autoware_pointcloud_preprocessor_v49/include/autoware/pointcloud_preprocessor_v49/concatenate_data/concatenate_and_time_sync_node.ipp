...
#include "autoware/pointcloud_preprocessor_v49/diagnostics/format_utils.hpp"
...
: Node("point_cloud_concatenator_component", node_options)
{
  ...
  debug_publisher_ = std::make_unique<DebugPublisher>(this, "concatenate_data_v49_synchronizer");
