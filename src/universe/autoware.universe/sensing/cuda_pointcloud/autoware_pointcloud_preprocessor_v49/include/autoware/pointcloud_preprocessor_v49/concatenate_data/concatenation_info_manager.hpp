...
const std::unordered_map<std::string, uint8_t> matching_strategy_name_map = {
  {"naive", autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo::STRATEGY_NAIVE},
  {"advanced", autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo::STRATEGY_ADVANCED},
};
...
public:
   ...
   */
  [[nodiscard]] autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo reset_and_get_base_info()
  {
  ...
  void update_source_from_point_cloud(
    ...
    autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo & out_concatenated_point_cloud_info_msg)
  {
    ...
    if (status != autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_OK) return;
...
private:
  ...
  struct SourceCloudInfo
  {
    ...
    autoware_sensing_msgs_v49::msg::SourcePointCloudInfo * target_info;
  ...
  [[nodiscard]] SourceCloudInfo find_source_info_and_next_idx(
    ...
    const
  {
    autoware_sensing_msgs_v49::msg::SourcePointCloudInfo * target_info = nullptr;
   ...
   */
  [[nodiscard]] autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo
  create_concatenation_info_base(
    const std::string & matching_strategy_name, const std::vector<std::string> & input_topics) const
  {
    autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo concatenated_point_cloud_info_base;
    ...
    for (const auto & topic : input_topics) {
      autoware_sensing_msgs_v49::msg::SourcePointCloudInfo info;
      info.topic = topic;
      info.status = autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_TIMEOUT;
  ...
  const autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo
    concatenated_point_cloud_info_base_msg_;
