...
#include "autoware/pointcloud_preprocessor_v49/utility/geometry.hpp"
...
{
class VectorMapInsideAreaFilterComponent : public autoware::pointcloud_preprocessor_v49::Filter
{
private:
  void filter(
    const PointCloud2ConstPtr & input, const IndicesPtr & indices, PointCloud2 & output) override;

  rclcpp::Subscription<autoware_map_msgs_v49::msg::LaneletMapBin>::SharedPtr map_sub_;
  lanelet::ConstPolygons3d polygon_lanelets_;

  void mapCallback(const autoware_map_msgs_v49::msg::LaneletMapBin::ConstSharedPtr msg);
