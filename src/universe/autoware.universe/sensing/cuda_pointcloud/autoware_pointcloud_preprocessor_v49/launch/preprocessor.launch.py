...
def launch_setup(context, *args, **kwargs):
    ...
    pkg = "autoware_pointcloud_preprocessor_v49"
    ...
    concatenate_and_time_sync_node_v49_param = ParameterFile(
        param_file=LaunchConfiguration("concatenate_and_time_sync_node_v49_param_path").perform(
            context
        ),
        allow_substs=True,
    )
    concatenate_pointclouds_node_v49_param = ParameterFile(
        param_file=LaunchConfiguration("concatenate_pointclouds_node_v49_param_path").perform(context),
        allow_substs=True,
    )
    time_synchronizer_node_v49_param = ParameterFile(
        param_file=LaunchConfiguration("time_synchronizer_node_v49_param_path").perform(context),
        allow_substs=True,
    )
    crop_box_filter_node_v49_param = ParameterFile(
        param_file=LaunchConfiguration("crop_box_filter_node_v49_param_path").perform(context),
        allow_substs=True,
    )
    ...
    if not is_separate_concatenate_node_and_time_sync_node:
        sync_and_concat_component = ComposableNode(
            ...
            parameters=[
                concatenate_and_time_sync_node_v49_param,
                {
        ...
        time_sync_component = ComposableNode(
            ...
            parameters=[
                time_synchronizer_node_v49_param,
                {
                    "input_topics": LaunchConfiguration("input_points_raw_list"),
                    "output_frame": LaunchConfiguration("tf_output_frame"),
                },
        ...
        concat_component = ComposableNode(
            ...
            parameters=[
                concatenate_pointclouds_node_v49_param,
                {
                    "input_topics": LaunchConfiguration("input_points_raw_list"),
                    "output_frame": LaunchConfiguration("tf_output_frame"),
                },
    ...
    cropbox_component = ComposableNode(
        ...
        parameters=[
            crop_box_filter_node_v49_param,
            {
...
def generate_launch_description():
    ...
    autoware_pointcloud_preprocessor_share_dir = get_package_share_directory(
        "autoware_pointcloud_preprocessor_v49"
    )
    ...
    add_launch_arg(
        "concatenate_and_time_sync_node_v49_param_path",
        os.path.join(
    ...
    add_launch_arg(
        "concatenate_pointclouds_node_v49_param_path",
        os.path.join(
            autoware_pointcloud_preprocessor_share_dir,
            "config",
    ...
    add_launch_arg(
        "time_synchronizer_node_v49_param_path",
        os.path.join(
            autoware_pointcloud_preprocessor_share_dir,
            "config",
    ...
    add_launch_arg(
        "crop_box_filter_node_v49_param_path",
        os.path.join(
            autoware_pointcloud_preprocessor_share_dir,
            "config",
