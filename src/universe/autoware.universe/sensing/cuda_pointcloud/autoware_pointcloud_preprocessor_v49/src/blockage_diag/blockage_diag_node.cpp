...
#include "autoware/pointcloud_preprocessor_v49/blockage_diag/blockage_diag_node.hpp"
...
: Filter("BlockageDiag", options)
{
  ...
  if (enable_dust_diag_) {
    ...
    ground_dust_ratio_pub_ = create_publisher<autoware_internal_debug_msgs_v49::msg::Float32Stamped>(
  ...
  ground_blockage_ratio_pub_ = create_publisher<autoware_internal_debug_msgs_v49::msg::Float32Stamped>(
    "blockage_diag/debug/ground_blockage_ratio", rclcpp::SensorDataQoS());
  sky_blockage_ratio_pub_ = create_publisher<autoware_internal_debug_msgs_v49::msg::Float32Stamped>(
  ...
  const cv::Mat & no_return_mask, const DebugInfo & debug_info)
{
  ...
  autoware_internal_debug_msgs_v49::msg::Float32Stamped ground_dust_ratio_msg;
...
{
  autoware_internal_debug_msgs_v49::msg::Float32Stamped ground_blockage_ratio_msg;
  ...
  autoware_internal_debug_msgs_v49::msg::Float32Stamped sky_blockage_ratio_msg;
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::pointcloud_preprocessor_v49::BlockageDiagComponent)
