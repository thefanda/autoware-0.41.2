...
#include "autoware/pointcloud_preprocessor_v49/outlier_filter/polar_voxel_outlier_filter_node.hpp"
...
{
  return autoware::pointcloud_preprocessor_v49::utils::is_data_layout_compatible_with_point_xyzircaedt(
    input);
}
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::pointcloud_preprocessor_v49::PolarVoxelOutlierFilterComponent)
