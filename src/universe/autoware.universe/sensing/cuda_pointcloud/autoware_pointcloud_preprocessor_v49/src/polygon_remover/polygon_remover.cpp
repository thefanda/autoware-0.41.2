...
#include "autoware/pointcloud_preprocessor_v49/polygon_remover/polygon_remover.hpp"
...
{
  autoware::pointcloud_preprocessor_v49::utils::to_cgal_polygon(*polygon_in, polygon_cgal_);
  if (will_visualize_) {
    marker_.ns = "";
    marker_.id = 0;
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::pointcloud_preprocessor_v49::PolygonRemoverComponent)
