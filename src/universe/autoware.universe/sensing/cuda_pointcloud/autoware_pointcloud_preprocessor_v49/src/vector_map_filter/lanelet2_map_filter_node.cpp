...
#include "autoware/pointcloud_preprocessor_v49/vector_map_filter/lanelet2_map_filter_node.hpp"
...
: Node("LaneletMapFilter_v49", node_options)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware::pointcloud_preprocessor_v49::Lanelet2MapFilterComponent)
