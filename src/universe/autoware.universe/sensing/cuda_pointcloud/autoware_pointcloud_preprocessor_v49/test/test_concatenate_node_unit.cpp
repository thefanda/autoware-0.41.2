...
#include "autoware/pointcloud_preprocessor_v49/concatenate_data/cloud_collector.hpp"
#include "autoware/pointcloud_preprocessor_v49/concatenate_data/combine_cloud_handler.hpp"
#include "autoware/pointcloud_preprocessor_v49/concatenate_data/concatenate_and_time_sync_node.hpp"
...
using autoware::pointcloud_preprocessor_v49::CloudCollector;
using autoware::pointcloud_preprocessor_v49::CombineCloudHandler;
using autoware::pointcloud_preprocessor_v49::PointCloud2Traits;
using autoware::pointcloud_preprocessor_v49::PointCloudConcatenateDataSynchronizerComponent;
...
{
  auto naive_info = std::make_shared<autoware::pointcloud_preprocessor_v49::NaiveCollectorInfo>();
  ...
  auto naive_info_new =
    std::dynamic_pointer_cast<autoware::pointcloud_preprocessor_v49::NaiveCollectorInfo>(
      collector_info_new);
...
{
  auto advanced_info = std::make_shared<autoware::pointcloud_preprocessor_v49::AdvancedCollectorInfo>();
  advanced_info->timestamp = 10.0;
  advanced_info->noise_window = 0.1;
  collector_->set_info(advanced_info);
  auto collector_info_new = collector_->get_info();
  auto advanced_info_new =
    std::dynamic_pointer_cast<autoware::pointcloud_preprocessor_v49::AdvancedCollectorInfo>(
      collector_info_new);
...
TEST_F(ConcatenateCloudTest, TestProcessSingleCloud)
{
  ...
  EXPECT_EQ(
    collector_->get_status(), autoware::pointcloud_preprocessor_v49::CollectorStatus::Processing);
  ...
  EXPECT_EQ(collector_->get_status(), autoware::pointcloud_preprocessor_v49::CollectorStatus::Finished);
  concatenate_node_->manage_collector_list();
  EXPECT_EQ(
    concatenate_node_->get_cloud_collectors().front()->get_status(),
    autoware::pointcloud_preprocessor_v49::CollectorStatus::Idle);
}
