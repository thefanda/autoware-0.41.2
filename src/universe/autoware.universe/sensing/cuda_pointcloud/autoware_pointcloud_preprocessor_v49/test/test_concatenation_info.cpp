...
#include <autoware/pointcloud_preprocessor_v49/concatenate_data/concatenation_info_manager.hpp>
#include <builtin_interfaces/msg/time.hpp>

#include <autoware_sensing_msgs_v49/msg/concatenated_point_cloud_info.hpp>
#include <autoware_sensing_msgs_v49/msg/source_point_cloud_info.hpp>
...
using autoware::pointcloud_preprocessor_v49::ConcatenationInfoManager;
using autoware::pointcloud_preprocessor_v49::StrategyAdvancedConfig;
...
TEST_F(ConcatenationInfoTest, ConstructorAndGetConcatInfoBase)
{
  ...
  for (size_t i = 0; i < input_topics_.size(); ++i) {
    ...
    EXPECT_EQ(
      ...
      autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_TIMEOUT);
  ...
  EXPECT_EQ(
    ...
    autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo::STRATEGY_ADVANCED);
}
...
TEST_F(ConcatenationInfoTest, ApplySourceWithPointCloud)
{
  ...
  concatenation_info_manager.update_source_from_point_cloud(
    test_cloud_1_, input_topics_[0], autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_OK,
  ...
  EXPECT_EQ(first_source.status, autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_OK);
  ...
  concatenation_info_manager.update_source_from_point_cloud(
    test_cloud_2_, input_topics_[1], autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_OK,
    concatenated_point_cloud_info_msg);
...
TEST_F(ConcatenationInfoTest, ApplySourceWithPointCloudNonOkStatus)
{
  ...
  concatenation_info_manager.update_source_from_point_cloud(
    ...
    autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_INVALID,
    concatenated_point_cloud_info_msg);

  // Check that header and status are updated, but idx_begin and length are not
  auto & first_source = concatenated_point_cloud_info_msg.source_info[0];
  EXPECT_EQ(first_source.status, autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_INVALID);
  EXPECT_EQ(first_source.header.frame_id, test_cloud_1_.header.frame_id);
...
TEST_F(ConcatenationInfoTest, ApplySourceWithStatus)
{
  ...
  concatenation_info_manager.update_source_from_status(
    input_topics_[0], autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_TIMEOUT,
    concatenated_point_cloud_info_msg);

  auto & first_source = concatenated_point_cloud_info_msg.source_info[0];
  EXPECT_EQ(first_source.status, autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_TIMEOUT);
  EXPECT_EQ(first_source.topic, input_topics_[0]);
}
...
TEST_F(ConcatenationInfoTest, ApplySourceWithNonExistentTopic)
{
  ...
  EXPECT_THROW(
    concatenation_info_manager.update_source_from_point_cloud(
      ...
      autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_OK,
      concatenated_point_cloud_info_msg),
    std::runtime_error);
}
...
TEST_F(ConcatenationInfoTest, NaiveStrategy)
{
  ...
  EXPECT_EQ(
    concatenated_point_cloud_info_msg.matching_strategy,
    autoware_sensing_msgs_v49::msg::ConcatenatedPointCloudInfo::STRATEGY_NAIVE);
}
...
TEST_F(ConcatenationInfoTest, MultiplePointCloudIndexing)
{
  ...
  concatenation_info_manager.update_source_from_point_cloud(
    test_cloud_3_, input_topics_[2], autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_OK,
    concatenated_point_cloud_info_msg);
...
TEST_F(ConcatenationInfoTest, UpdateConcatenatedPointCloudResultWithMixedStatus)
{
  ...
  concatenation_info_manager.update_source_from_status(
    input_topics_[2], autoware_sensing_msgs_v49::msg::SourcePointCloudInfo::STATUS_TIMEOUT,
    concatenated_point_cloud_info_msg);
