...
protected:
  void SetUp() override
  {
    ...
    distortion_corrector_2d_ =
      std::make_shared<autoware::pointcloud_preprocessor_v49::DistortionCorrector2D>(*node_);
    distortion_corrector_3d_ =
      std::make_shared<autoware::pointcloud_preprocessor_v49::DistortionCorrector3D>(*node_);
  ...
  std::shared_ptr<autoware::pointcloud_preprocessor_v49::DistortionCorrector2D>
    distortion_corrector_2d_;
  std::shared_ptr<autoware::pointcloud_preprocessor_v49::DistortionCorrector3D>
    distortion_corrector_3d_;
