...
#include "autoware/pointcloud_preprocessor_v49/downsample_filter/pickup_based_voxel_grid_downsample_filter_node.hpp"
...
TEST(DownsampleWithVoxelGridTest, TestBasicDownsampling)
{
  ...
  autoware::pointcloud_preprocessor_v49::VoxelSize voxel_size = {0.1f, 0.1f, 0.1f};
  sensor_msgs::msg::PointCloud2 output_cloud;

  // Call the function under test
  autoware::pointcloud_preprocessor_v49::downsample_with_voxel_grid(
...
TEST(DownsampleWithVoxelGridTest, TestDifferentVoxelSizes)
{
  ...
  {
    autoware::pointcloud_preprocessor_v49::VoxelSize small_voxel = {0.05f, 0.05f, 0.05f};
    sensor_msgs::msg::PointCloud2 output_cloud;
    autoware::pointcloud_preprocessor_v49::downsample_with_voxel_grid(
  ...
  {
    autoware::pointcloud_preprocessor_v49::VoxelSize large_voxel = {1.0f, 1.0f, 1.0f};
    sensor_msgs::msg::PointCloud2 output_cloud;
    autoware::pointcloud_preprocessor_v49::downsample_with_voxel_grid(
