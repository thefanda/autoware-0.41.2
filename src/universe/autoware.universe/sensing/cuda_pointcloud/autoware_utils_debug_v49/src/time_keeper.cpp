...
autoware_internal_debug_msgs_v49::msg::ProcessingTimeTree ProcessingTimeNode::to_msg() const
{
  autoware_internal_debug_msgs_v49::msg::ProcessingTimeTree time_tree_msg;

  std::function<void(
    const ProcessingTimeNode &, autoware_internal_debug_msgs_v49::msg::ProcessingTimeTree &, int)>
    construct_msg = [&](
                      const ProcessingTimeNode & node,
                      autoware_internal_debug_msgs_v49::msg::ProcessingTimeTree & tree_msg,
                      int parent_id) {
      autoware_internal_debug_msgs_v49::msg::ProcessingTimeNode time_node_msg;
