...
#include <autoware_internal_planning_msgs_v49/msg/path_point_with_lane_id.hpp>
#include <autoware_internal_planning_msgs_v49/msg/path_with_lane_id.hpp>
#include <autoware_planning_msgs_v49/msg/path.hpp>
#include <autoware_planning_msgs_v49/msg/path_point.hpp>
#include <autoware_planning_msgs_v49/msg/trajectory.hpp>
#include <autoware_planning_msgs_v49/msg/trajectory_point.hpp>
...
template <>
inline geometry_msgs::msg::Point get_point(const autoware_planning_msgs_v49::msg::PathPoint & p)
{
  return p.pose.position;
}
...
inline geometry_msgs::msg::Point get_point(
  const autoware_internal_planning_msgs_v49::msg::PathPointWithLaneId & p)
{
  return p.point.pose.position;
}

template <>
inline geometry_msgs::msg::Point get_point(const autoware_planning_msgs_v49::msg::TrajectoryPoint & p)
{
  return p.pose.position;
}
...
template <>
inline geometry_msgs::msg::Pose get_pose(const autoware_planning_msgs_v49::msg::PathPoint & p)
{
  return p.pose;
}
...
template <>
inline geometry_msgs::msg::Pose get_pose(const autoware_planning_msgs_v49::msg::TrajectoryPoint & p)
{
  return p.pose;
}
...
template <>
inline double get_longitudinal_velocity(const autoware_planning_msgs_v49::msg::PathPoint & p)
{
...
template <>
inline double get_longitudinal_velocity(const autoware_planning_msgs_v49::msg::TrajectoryPoint & p)
{
  return p.longitudinal_velocity_mps;
}
...
inline void set_pose(
  const geometry_msgs::msg::Pose & pose, autoware_planning_msgs_v49::msg::PathPoint & p)
{
  p.pose = pose;
}
...
template <>
inline void set_pose(
  const geometry_msgs::msg::Pose & pose, autoware_planning_msgs_v49::msg::TrajectoryPoint & p)
{
  p.pose = pose;
}
...
inline void set_longitudinal_velocity(
  const float velocity, autoware_planning_msgs_v49::msg::TrajectoryPoint & p)
{
...
template <>
inline void set_longitudinal_velocity(
  const float velocity, autoware_planning_msgs_v49::msg::PathPoint & p)
{
  p.longitudinal_velocity_mps = velocity;
}
...
template <>
inline void set_longitudinal_velocity(
  const float velocity, autoware_internal_planning_msgs_v49::msg::PathPointWithLaneId & p)
{
