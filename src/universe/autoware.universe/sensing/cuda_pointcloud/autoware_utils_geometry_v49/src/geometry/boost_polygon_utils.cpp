  ...
  const geometry_msgs::msg::Pose & pose, const autoware_perception_msgs_v49::msg::Shape & shape)
{
  ...
  if (shape.type == autoware_perception_msgs_v49::msg::Shape::BOUNDING_BOX) {
  ...
  } else if (shape.type == autoware_perception_msgs_v49::msg::Shape::CYLINDER) {
  ...
  } else if (shape.type == autoware_perception_msgs_v49::msg::Shape::POLYGON) {
...
autoware_utils_geometry::Polygon2d to_polygon2d(
  const autoware_perception_msgs_v49::msg::DetectedObject & object)
{
...
autoware_utils_geometry::Polygon2d to_polygon2d(
  const autoware_perception_msgs_v49::msg::TrackedObject & object)
{
  return autoware_utils_geometry::to_polygon2d(
    object.kinematics.pose_with_covariance.pose, object.shape);
}
...
autoware_utils_geometry::Polygon2d to_polygon2d(
  const autoware_perception_msgs_v49::msg::PredictedObject & object)
{
  return autoware_utils_geometry::to_polygon2d(
