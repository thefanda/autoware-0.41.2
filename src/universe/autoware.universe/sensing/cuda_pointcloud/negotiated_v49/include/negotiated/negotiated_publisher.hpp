 ...
 *                              negotiation.
 *
 * \return A vector of negotiated_interfaces_v49::msg::SupportedType structures, one for each of the
...
struct NegotiatedPublisherOptions final
{
  ...
  std::function<std::vector<negotiated_interfaces_v49::msg::SupportedType>(
  ...
  std::function<void(
      ...
      const std::unordered_set<std::shared_ptr<detail::UpstreamNegotiatedSubscriptionHandle>> &,
      const negotiated_interfaces_v49::msg::SupportedTypes &,
      const negotiated_interfaces_v49::msg::SupportedTypes &,
      detail::PublisherGid)>
  ...
  std::function<void(const negotiated_interfaces_v49::msg::NegotiatedTopicsInfo &)>
...
private:
  ...
  rclcpp::Publisher<negotiated_interfaces_v49::msg::NegotiatedTopicsInfo>::SharedPtr
    negotiated_publisher_;

  /// The transient local subscription that gathers supported types from NegotiatedSubscriptions.
  rclcpp::Subscription<negotiated_interfaces_v49::msg::SupportedTypes>::SharedPtr supported_types_sub_;
  ...
  negotiated_interfaces_v49::msg::NegotiatedTopicsInfo negotiated_topics_info_;
};
