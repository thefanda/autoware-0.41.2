 ...
 */
negotiated_interfaces_v49::msg::NegotiatedTopicInfo default_negotiate_cb(
  const negotiated_interfaces_v49::msg::NegotiatedTopicInfo & existing_info,
  const negotiated_interfaces_v49::msg::NegotiatedTopicsInfo & msg);
...
struct NegotiatedSubscriptionOptions
{
  ...
  std::function<negotiated_interfaces_v49::msg::NegotiatedTopicInfo(
      const negotiated_interfaces_v49::msg::NegotiatedTopicInfo & existing_info,
      const negotiated_interfaces_v49::msg::NegotiatedTopicsInfo & msg)> negotiate_cb{
...
public:
  ...
  struct SupportedTypeInfo final
  {
    ...
    negotiated_interfaces_v49::msg::SupportedType supported_type;
  ...
  void remove_all_downstream_supported_types(
    const negotiated_interfaces_v49::msg::SupportedTypes & downstream_types);
   ...
   */
  const negotiated_interfaces_v49::msg::NegotiatedTopicsInfo & get_negotiated_topics_info() const;
   ...
   */
  const negotiated_interfaces_v49::msg::NegotiatedTopicInfo & get_existing_topic_info() const;
...
private:
   ...
   */
  void topics_info_cb(const negotiated_interfaces_v49::msg::NegotiatedTopicsInfo & msg);
  ...
  rclcpp::Subscription<negotiated_interfaces_v49::msg::NegotiatedTopicsInfo>::SharedPtr
  ...
  rclcpp::Publisher<negotiated_interfaces_v49::msg::SupportedTypes>::SharedPtr supported_types_pub_;

  /// Saved information about the currently connected data topic.
  negotiated_interfaces_v49::msg::NegotiatedTopicInfo existing_topic_info_;

  /// A list of all of the topics that the publisher sent to us, that we also support.
  negotiated_interfaces_v49::msg::NegotiatedTopicsInfo negotiated_topics_;
