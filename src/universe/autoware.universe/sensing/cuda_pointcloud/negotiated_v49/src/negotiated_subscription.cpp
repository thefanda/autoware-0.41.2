...
{
  negotiated_interfaces_v49::msg::NegotiatedTopicInfo matched_info;

  if (!msg.success) {
    return matched_info;
  }

  for (const negotiated_interfaces_v49::msg::NegotiatedTopicInfo & info : msg.negotiated_topics) {
  ...
  negotiated_sub_options_(negotiated_sub_options)
{
  negotiated_subscription_ =
    rclcpp::create_subscription<negotiated_interfaces_v49::msg::NegotiatedTopicsInfo>(
    node_parameters_,
    node_topics_,
    topic_name,
    rclcpp::QoS(10),
  ...
  supported_types_pub_ = rclcpp::create_publisher<negotiated_interfaces_v49::msg::SupportedTypes>(
    node_parameters_,
    node_topics_,
...
{
  auto supported_types = negotiated_interfaces_v49::msg::SupportedTypes();
  ...
  const PublisherGid & gid)
{
  ...
  for (const negotiated_interfaces_v49::msg::SupportedType & type_to_remove :
  ...
  for (const negotiated_interfaces_v49::msg::SupportedType & type_to_add :
...
{
  for (const negotiated_interfaces_v49::msg::SupportedType & type : downstream_types.supported_types) {
...
const negotiated_interfaces_v49::msg::NegotiatedTopicInfo &
