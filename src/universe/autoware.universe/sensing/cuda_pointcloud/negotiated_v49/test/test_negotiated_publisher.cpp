...
protected:
  ...
  rclcpp::Publisher<negotiated_interfaces_v49::msg::SupportedTypes>::SharedPtr
    ...
    const std::vector<std::string> & supported_type_names)
  {
    ...
    auto dummy_foo_supported_types =
      node_->create_publisher<negotiated_interfaces_v49::msg::SupportedTypes>(
      "foo/_supported_types", rclcpp::QoS(10).transient_local());

    negotiated_interfaces_v49::msg::SupportedTypes dummy_supported_types;
...
{
  rclcpp::Publisher<negotiated_interfaces_v49::msg::SupportedTypes>::SharedPtr dummy =
  ...
  negotiated_interfaces_v49::msg::NegotiatedTopicsInfo topics_info = pub->get_negotiated_topics_info();
...
TEST_F(TestNegotiatedPublisher, two_subscriptions_same_type)
{
  ...
  rclcpp::Publisher<negotiated_interfaces_v49::msg::SupportedTypes>::SharedPtr dummy2 =
    create_and_publish_foo_supported_types({"std_msgs/msg/Empty"}, {"a"});
...
TEST_F(TestNegotiatedPublisher, successful_negotiation_callback)
{
  ...
  options.successful_negotiation_cb =
    [&negotiation_cb_called](const negotiated_interfaces_v49::msg::NegotiatedTopicsInfo & topics)
    {
      (void)topics;
...
TEST_F(TestNegotiatedPublisher, negotiation_callback)
{
  ...
  options.negotiation_cb =
    [](const std::map<negotiated::detail::PublisherGid,
      ...
      size_t maximum_solutions) -> std::vector<negotiated_interfaces_v49::msg::SupportedType>
    {
      ...
      std::vector<negotiated_interfaces_v49::msg::SupportedType> ret(1);
...
TEST_F(TestNegotiatedPublisher, negotiation_callback_empty_set)
{
  ...
  options.negotiation_cb =
      ...
      size_t maximum_solutions) -> std::vector<negotiated_interfaces_v49::msg::SupportedType>
    {
      ...
      // an empty vector.
      return std::vector<negotiated_interfaces_v49::msg::SupportedType>();
    };
...
TEST_F(TestNegotiatedPublisher, single_subscription_with_upstream_sub)
{
  ...
  auto upstream_dummy_topics_pub =
    node_->create_publisher<negotiated_interfaces_v49::msg::NegotiatedTopicsInfo>(
    "bar", rclcpp::QoS(10));
