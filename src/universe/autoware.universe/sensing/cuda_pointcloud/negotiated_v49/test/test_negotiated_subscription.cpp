...
protected:
  void SetUp()
  {
    ...
    topics_pub_ = node_->create_publisher<negotiated_interfaces_v49::msg::NegotiatedTopicsInfo>(
      "foo", rclcpp::QoS(10));
  }
  ...
  rclcpp::Publisher<negotiated_interfaces_v49::msg::NegotiatedTopicsInfo>::SharedPtr topics_pub_;
};
...
TEST_F(TestNegotiatedSubscription, add_single_callback)
{
  ...
  auto topics_msg = std::make_unique<negotiated_interfaces_v49::msg::NegotiatedTopicsInfo>();
  topics_msg->success = true;

  negotiated_interfaces_v49::msg::NegotiatedTopicInfo topic_info;
...
TEST_F(TestNegotiatedSubscription, renegotiate_keep_same_topic)
{
  ...
  negotiated_interfaces_v49::msg::NegotiatedTopicsInfo topics_msg;
  topics_msg.success = true;
  ...
  negotiated_interfaces_v49::msg::NegotiatedTopicInfo topic_info1;
  ...
  negotiated_interfaces_v49::msg::NegotiatedTopicInfo topic_info2;
...
TEST_F(TestNegotiatedSubscription, custom_negotiated_cb)
{
  ...
  auto custom_negotiate_cb =
    ...
    negotiated_interfaces_v49::msg::NegotiatedTopicInfo
    {
      (void)existing_info;

      if (msg.negotiated_topics.size() < 2) {
        return negotiated_interfaces_v49::msg::NegotiatedTopicInfo();
      }
...
TEST_F(TestNegotiatedSubscription, get_empty_supported_topics)
{
  ...
  negotiated_interfaces_v49::msg::NegotiatedTopicsInfo info = sub->get_negotiated_topics_info();
...
TEST_F(TestNegotiatedSubscription, get_multiple_supported_topics)
{
  ...
  negotiated_interfaces_v49::msg::NegotiatedTopicInfo existing = sub->get_existing_topic_info();
...
TEST_F(TestNegotiatedSubscription, downstream_supported_types_no_overlap)
{
  ...
  negotiated_interfaces_v49::msg::SupportedTypes dummy_types_to_remove;
